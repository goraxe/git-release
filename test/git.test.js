...
import { add, commit, getModifiedFiles, gitHead, push } from "../lib/git.js";
import {
  gitCommits,
  gitGetCommits,
  gitRemoteHead,
...
test("Get the modified files, including files in .gitignore but including untracked ones", async (t) => {
  ...
  await appendFileSync(path.resolve(cwd, "file1.js"), "Test content");
  await appendFileSync(
    path.resolve(cwd, "dir/file2.js"),
    "Test content",
  );
  await appendFileSync(path.resolve(cwd, "file3.js"), "Test content");
  // Add untracked file
