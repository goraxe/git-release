import { castArray, isArray, isPlainObject, template, uniq } from "lodash-es";
...
import { add, commit, getModifiedFiles, push } from "./git.js";
...
export default async (pluginConfig, context) => {
  ...
  const { message, assets, publishPush } = resolveConfig(pluginConfig, logger);
